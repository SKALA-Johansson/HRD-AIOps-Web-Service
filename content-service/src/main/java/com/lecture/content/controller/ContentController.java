...
public class ContentController {
    ...
    public ResponseEntity<ApiResponse<List<ContentRequest>>> listContents(
        ...
        // Mocking list based on specifications
        ContentRequest mockContent = ContentRequest.builder()
        ...
        return ResponseEntity.ok(ApiResponse.success("Success", Collections.singletonList(mockContent)));
    }
